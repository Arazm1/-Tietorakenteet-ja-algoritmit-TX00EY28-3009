...
class HashTable():
    ...
    def get(self, key, alternative=None):
        ...
        """
        i = self._hash(key)
        existing_index = self._find_key(i, key)

        # Key exist, return value
        if existing_index is not None:
            value = self.slots[existing_index].value
            return 
        # Key doesnt exist, return alternative
        else:
            return alternative
    ...
    def __setitem__(self, key, value):
        """
        Set or updates the value of element 'key'.
        Use: hashtable[key] = value
        Parameters:
        - 'key': The key to add or update
        - 'value': The value of the key
        Returns: None
    ...
    def __getitem__(self, key):
        """
        Get value of element 'key'
        Use: hashtable[key]
        Parameters:
        - 'key': The key to get the value
        Returns: The value of given key. Raises error if key was not found
        """
