...
class Tree():
    ...
    def _find(self, data):
        ...
        current_node = self._root_node
        parent_node = None
        # find_node = Node(data, parent_node=None) - dont need this

        # Try to get current_node == find_node

        while current_node is not None:
            parent_node = current_node

            # If find_node value is smaller than current_node
            if data == current_node.data:
                return current_node
            ...
            # If find_node value is higher than current_node
            else:
