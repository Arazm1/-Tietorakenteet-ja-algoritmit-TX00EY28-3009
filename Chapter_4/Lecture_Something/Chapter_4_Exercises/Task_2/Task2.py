...
def check_balance(text):
    ...
    if stack._size != 0:
        # Pop the leftover bracket to get its actual position
        last, leftover_position = stack.pop()
        return f'Match error at position {leftover_position}'

    return f'Ok - {found_pairs}'